...
class Data_OrdersAccepted{
  ...
  Data_OrdersAccepted(this.id_order,this.id_user_order,this.address_order,this.phone_order,this.date_order,this.namepickup_order);

  Data_OrdersAccepted.fromJson(Map<String, dynamic> json){

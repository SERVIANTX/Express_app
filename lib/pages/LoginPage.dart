...
class _LoginPageState extends State<LoginPage>{
          ...
          children:[
                        ...
                        Row(
                            ...
                            children: [
                              Checkbox(
                                ...
                                const Expanded(child: Text("Recuérdame", style: TextStyle(fontSize: 16,color: Colors.black,fontFamily: 'Antipasto'))),
            ...
            Container(
              margin: const EdgeInsets.all(25),
                    ...
                    child: FlatButton (
                      child: const Text('INICIAR SESION', style: TextStyle(color: Colors.white, fontSize: 18,fontFamily: 'Antipasto'),),
                      onPressed: () async {
                        ...
                        if(em == '' || pass == ''){
                          ...
                          const snackBar = SnackBar(
                            content: Text('Correo o Contraseña se encuentra vacio!',style: TextStyle(fontSize: 16.0,fontFamily: 'Antipasto'), textAlign: TextAlign.center,),
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(snackBar);
                            ...
                            if(result.statusCode == 200){
                              ...
                              if(isChecked == true){
                                guardar_datos(em, pass, token, id);
                              }
                            ...
                            const snackBar = SnackBar(
                            content: Text('Correo o Contraseña Erroneos!',style: TextStyle(fontSize: 16.0,fontFamily: 'Antipasto'), textAlign: TextAlign.center,),
                            backgroundColor: Color.fromARGB(255, 42, 146, 39),
                            duration: Duration(seconds: 2),
                            padding: EdgeInsets.all(16.0),
                            );
  ...
  Future<void> guardar_datos(em, pass, token,id) async{
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: const [
          ...
          Text('Login', style: TextStyle(color: Colors.black, fontSize: 32.5,fontFamily: 'Antipasto')),
                  SizedBox(height: 7.5),
                  /// WELCOME
          Text('Bienvenido de vuelta!', style: TextStyle(color: Colors.black, fontSize: 18,fontFamily: 'Antipasto')),
        ],
      ),
      );
  }
